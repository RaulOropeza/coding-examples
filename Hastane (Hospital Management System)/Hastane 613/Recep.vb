Public Class frmRecep
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Hide()
        frmCambio.Show()
    End Sub

    Private Sub frmRecep_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        frmHome.Show()
    ...
    Private Sub frmRecep_Load(sender As Object, e As EventArgs) Handles MyBase.Load
