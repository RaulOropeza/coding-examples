Public Class frmDirGen
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Hide()
        frmCambio.Show()
    End Sub

    Private Sub frmDirGen_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        frmHome.Show()
    ...
    Private Sub frmDirGen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
